...
public class ArtemisInstance {
    ...
    /**
     *
     * @return the protocol with which to communicate with Artemis as an URL prefix, e.g. https://
     */
    ...
    /**
     *
     * @return the hostname of the Artemis instance (without protocol!), e.g. artemis.kit.edu
     */
