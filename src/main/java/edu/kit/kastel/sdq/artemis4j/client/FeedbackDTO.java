 ...
 *                            feedback
 */
public record FeedbackDTO(@JsonProperty FeedbackType type, @JsonProperty Integer id, @JsonProperty double credits, @JsonProperty Boolean positive,
        @JsonProperty String visibility, @JsonProperty String text, @JsonProperty String reference, @JsonProperty String detailText,
    ...
    public FeedbackDTO(String detailText, FeedbackDTO other) {
        this(other.type(), other.id(), other.credits(), other.positive(), other.visibility(), other.text(), other.reference(), detailText,
                other.hasLongFeedbackText(), other.testCase());
    }
}
